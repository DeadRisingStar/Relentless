  ...
  if (globalHookErrors < 5) {
    sa
      ...
      .send({
        ...
        username: `Fatal Error Relentless Webhook Notification`,
        embeds: [{
          title: 'Fatal',
          description: message,
          color: 16777215
...
function error (message) {
  if (globalHookErrors < 5) {
    sa
      ...
      .send({
        avatar_url: 'https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-bell-512.png',
        username: `Error Relentless Webhook Notification`,
        embeds: [{
          title: 'Error',
          description: message,
          color: 16711680
...
function warn (message) {
  if (globalHookErrors < 5) {
    sa
      ...
      .send({
        avatar_url: 'https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-bell-512.png',
        username: `Warning Relentless Webhook Notification`,
        embeds: [{
          title: 'Warning',
          description: message,
          color: 15466375
...
function generic (message) {
  if (globalHookErrors < 5) {
    sa
      ...
      .send({
        avatar_url: 'https://cdn4.iconfinder.com/data/icons/ionicons/512/icon-ios7-bell-512.png',
        username: `Generic Relentless Webhook Notification`,
        embeds: [{
          title: 'Generic',
          description: message,
          color: 6052351
